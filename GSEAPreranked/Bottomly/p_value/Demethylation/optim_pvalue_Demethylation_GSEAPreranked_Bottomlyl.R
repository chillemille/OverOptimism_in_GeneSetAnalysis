...
for(i in 1:ncol(phen_bottomly)){
  ...
  # Create path for storage of limma ranking            
  path_limma_phenperm <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Phenotype_Permutation",i,"/limma_ranking_permutation",i,".txt")
