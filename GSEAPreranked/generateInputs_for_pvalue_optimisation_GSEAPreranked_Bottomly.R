...
dir.create("./GSEAPreranked/Bottomly/p_value")

dir.create("./GSEAPreranked/Bottomly/p_value/Data")

dir.create("./GSEAPreranked/Bottomly/p_value/Data/Raw")

dir.create("./GSEAPreranked/Bottomly/p_value/Data/Prep")

dir.create("./GSEAPreranked/Bottomly/p_value/Data/Prep/Original_Phenotype")
dir.create("./GSEAPreranked/Bottomly/p_value/Data/Raw/Original_Phenotype")

for(i in 1:10){

  path_raw <- paste0("./GSEAPreranked/Bottomly/p_value/Data/Raw/Phenotype_Permutation",
                     i)

  path_prep <- paste0("./GSEAPreranked/Bottomly/p_value/Data/Prep/Phenotype_Permutation",
                      i)
