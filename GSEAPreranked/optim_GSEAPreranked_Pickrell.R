...
path_DESeq2_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/GSEAPreranked/Pickrell/Data/Raw/Original_Phenotype/DESeq2_ranking_phenOrig.txt"
...
path_limma_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/GSEAPreranked/Pickrell/Data/Raw/Original_Phenotype/limma_ranking_phenOrig.txt"
...
###############################
# ranking by Signal2Noise Ratio
###############################
                 
# Signal2Noise_ranking_phenorig <- pre_filt(Biobase::exprs(pickrell.eset), threshold=10) %>% geneID_conversion_SYMBOL(dupl_removal_method = 1) %>% 
#                                  voom_trans(phenotype_labels = pickrell.eset$gender, normmethod="TMM") %>% 
#                                  signal2noise_ratio(phenotype_labels = pickrell.eset$gender) %>% sort(decreasing=TRUE)
# 
# path_S2NR_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/GSEAPreranked/Pickrell/Data/Raw/Original_Phenotype/S2NR_ranking_phenOrig.txt"
# 
# 
# # export 
# write.table(Signal2Noise_ranking_phenorig, 
#             file = path_S2NR_phenorig, 
#             quote = FALSE, 
#             row.names = TRUE, 
#             col.names = FALSE)
...
# create path for storage of DESeq2 ranking
path_DESeq2_phenperm <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/GSEAPreranked/Pickrell/Data/Raw/Phenotype_Permutation",i,"/DESeq2_ranking_permutation",i,".txt")
...
# Create path for storage of limma ranking            
path_limma_phenperm <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/GSEAPreranked/Pickrell/Data/Raw/Phenotype_Permutation",i,"/limma_ranking_permutation",i,".txt")
