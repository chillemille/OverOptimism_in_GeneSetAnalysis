...
# Demethylation
load("./Results/Intermediate_results/optimP_GOSeq_Demethylation_Pickrell_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimP_GOSeq_tCell_Pickrell_OriginalPhenotype.RData")


# Load clusterProfiler's ORA results

# Demethylation
load("./Results/Intermediate_results/optimP_ORA_Demethylation_Pickrell_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimP_ORA_tCell_Pickrell_OriginalPhenotype.RData")
...
# Demethylation
load("./Results/Intermediate_results/optimP_cP_GSEA_Demethylation_Pickrell_OriginalPhenotype.RData")

# t-Cell mediated immunity
load("./Results/Intermediate_results/optimP_cP_GSEA_tCell_Pickrell_OriginalPhenotype.RData")


# Load PADOG results

# (i) Primary Immunodeficiency
load("./Results/Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Pickrell_OriginalPhenotype.RData")

# (ii) Graft vs Host
load("./Results/Intermediate_results/optimP_PADOG_GraftvsHost_Pickrell_OriginalPhenotype.RData")
...
# Demethylation
load("./Results/Intermediate_results/optimP_GOSeq_Demethylation_Pickrell_PhenotypePermutations.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimP_GOSeq_tCell_Pickrell_PhenotypePermutations.RData")


# Load clusterProfiler's ORA results

# Demethylation
load("./Results/Intermediate_results/optimP_ORA_Demethylation_Pickrell_PhenotypePermutations.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimP_ORA_tCell_Pickrell_PhenotypePermutations.RData")


# Load PADOG results

# (i) Primary Immunodeficiency
load("./Results/Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Pickrell_PhenotypePermutations.RData")

# (ii) Graft vs Host
load("./Results/Intermediate_results/optimP_PADOG_GraftvsHost_Pickrell_PhenotypePermutations.RData")
...
# (i) t Cell mediated immunity
load("./Results/Intermediate_results/optimP_cP_GSEA_tCell_Pickrell_PhenotypePermutations.RData")

# (ii) Demethylation
load("./Results/Intermediate_results/optimP_cP_GSEA_Demethylation_Pickrell_PhenotypePermutations.RData")
...
plot_padj <- plot_grid(plot_permutedlabels, plot_truelabels, labels=c("A", "B"), ncol = 1, nrow = 2)

## uncomment to save
ggsave2("./Results/Figures/Figure4.eps",
        width = 10,
        height = 12)
