...
# Demethylation
load("./Results/Intermediate_results/optimRank_GOSeq_MetabolicProcess_Bottomly_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimRank_GOSeq_CellularProcess_Bottomly_OriginalPhenotype.RData")


# Load clusterProfiler's ORA results

# Demethylation
load("./Results/Intermediate_results/optimRank_ORA_tCell_Bottomly_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimRank_ORA_Demethylation_Bottomly_OriginalPhenotype.RData")


# Load clusterProfiler's GSEA results

# Demethylation
load("./Results/Intermediate_results/optimRank_cP_GSEA_tCell_Bottomly_OriginalPhenotype.RData")

# t-Cell mediated immunity
load("./Results/Intermediate_results/optimRank_cP_GSEA_Demethylation_Bottomly_OriginalPhenotype.RData")


# Load PADOG results

# (i) Primary Immunodeficiency
load("./Results/Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_OriginalPhenotype.RData")

# (ii) Graft vs Host
load("./Results/Intermediate_results/optimRank_PADOG_GraftvsHost_Bottomly_OriginalPhenotype.RData")
...
# Demethylation
load("./Results/Intermediate_results/optimRank_GOSeq_MetabolicProcess_Bottomly_PhenotypePermutations.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimRank_GOSeq_CellularProcess_Bottomly_PhenotypePermutations.RData")


# Load clusterProfiler's ORA results

# Demethylation
load("./Results/Intermediate_results/optimRank_ORA_tCell_Bottomly_PhenotypePermutations.RData")

# t Cell mediated immunity
load("./Results/Intermediate_results/optimRank_ORA_Demethylation_Bottomly_PhenotypePermutations.RData")
...
# (i) Primary Immunodeficiency
load("./Results/Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_PhenotypePermutations.RData")

# (ii) Graft vs Host
load("./Results/Intermediate_results/optimRank_PADOG_GraftvsHost_Bottomly_PhenotypePermutations.RData")


# Load clusterProfiler's GSEA results

# Demethylation
load("./Results/Intermediate_results/optimRank_cP_GSEA_Demethylation_Bottomly_PhenotypePermutations.RData")

# t-Cell mediated immunity
load("./Results/Intermediate_results/optimRank_cP_GSEA_tCell_Bottomly_PhenotypePermutations.RData")
...
## uncomment to save
ggsave("./Results/Figures/FigureS4.eps",
       width = 10,
       height = 12)
