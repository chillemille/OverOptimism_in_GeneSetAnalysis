...
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Prep")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Prep/Phen_Original")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Prep/Phenotypes")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Original")
dir.create("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phenotypes")



for(i in 1:10){

  dir.create(paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Prep/Phen_Permutation", i))

  dir.create(paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation", i))
...
# export phenotype assignments and gene expression data set pre-processed in default manner
  ...
  path_phen <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phenotypes/Phenotype_original.txt")
  ...
  # generate path
  path_dat_phenorig <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_default_phen_original.txt")
  ...
  # generate path
  path_dat_vst_phenorig <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_vst_phen_original.txt")
...
#########
  ...
  ### export
  path_filterByExpr_phenorig <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_filterByExpr_phenorig.txt")
...
for(i in 1:ncol(phen_pickrell)){
  ...
  path_phen <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phenotypes/Phenotype_Permutation",
                      i,
                      ".txt")
  ...
  # generate path
  path_dat <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                     i,
  ...
  # generate path
  path_dat_vst <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                         i,
...
### export
path_filterByExpr_phen1 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
...
### export
path_filterByExpr_phen2 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen3 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen4 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen5 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen6 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen7 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i,
                                  ".txt")
...
### export
path_filterByExpr_phen8 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                  i,
                                  "/exprdat_filterByExpr_phen_permutation",
                                  i, "
                                  .txt")
...
### export
path_filterByExpr_phen9 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export
path_filterByExpr_phen10 <- paste0("./Results/Intermediate_results/GSEA_Web/Pickrell/p_value/Data_Demethylation/Raw/Phen_Permutation",
                                   i,
                                   "/exprdat_filterByExpr_phen_permutation",
                                   i,
                                   ".txt")
