...
dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS")

dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data")

dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw")

dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Prep")

dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Prep/Original_Phenotype")
dir.create("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Original_Phenotype")

for(i in 1:10){

  path_raw <- paste0("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Phenotype_Permutation",
                     i)

  path_prep <- paste0("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Prep/Phenotype_Permutation",
                      i)
...
path_DESeq2_phenorig <- "./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Original_Phenotype/DESeq2_ranking_phenOrig.txt"
...
path_limma_phenorig <- "./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Original_Phenotype/limma_ranking_phenOrig.txt"
...
# create path for storage of DESeq2 ranking
path_DESeq2_phenperm <- paste0("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Phenotype_Permutation",
                               i,
...
# Create path for storage of limma ranking
path_limma_phenperm <- paste0("./Results/Intermediate_results/GSEAPreranked/Pickrell/n_DEGS/Data/Raw/Phenotype_Permutation",
                              i,
