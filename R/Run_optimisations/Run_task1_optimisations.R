...
source("./R/Optimisation_functions/task1_OptimisationFunctions_GOSeq.R")
...
save(optim_GOSeq_results_Pickrell_originalphenotype,
     file = "./Results/Intermediate_results/GOSeq_Results_Pickrell_OriginalPhenotype.RData")
...
save(optim_GOSeq_results_Pickrell_phenotypepermutation,
     file = "./Results/Intermediate_results/GOSeq_Results_Pickrell_PhenotypePermutations.RData")
...
save(optim_GOSeq_results_Bottomly_originalphenotype,
     file = "./Results/Intermediate_results/GOSeq_Results_Bottomly_OriginalPhenotype.RData")
...
save(optim_GOSeq_results_Bottomly_phenotypepermutation,
     file = "./Results/Intermediate_results/GOSeq_Results_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Optimisation_functions/task1_OptimisationFunctions_PADOG.R")
...
save(optim_PADOG_results_Pickrell_originalphenotype,
     file = "./Results/Intermediate_results/PADOG_Results_Pickrell_OriginalPhenotype.RData")
...
save(optim_PADOG_results_Pickrell_phenotypepermutation,
     file = "./Results/Intermediate_results/PADOG_Results_Pickrell_PhenotypePermutations.RData")
...
save(optim_PADOG_results_Bottomly_originalphenotype,
     file = "./Results/Intermediate_results/PADOG_Results_Bottomly_OriginalPhenotype.RData")
...
save(optim_PADOG_results_Bottomly_phenotypepermutation,
     file = "./Results/Intermediate_results/PADOG_Results_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Optimisation_functions/task1_OptimisationFunctions_cP_ORA.R")
...
save(optim_ORA_results_Pickrell_originalphenotype,
     file = "./Results/Intermediate_results/ORA_Results_Pickrell_OriginalPhenotype.RData")
...
save(optim_ORA_results_Pickrell_phenotypepermutation,
     file = "./Results/Intermediate_results/ORA_Results_Pickrell_PhenotypePermutations.RData")
...
save(optim_ORA_results_Bottomly_originalphenotype,
     file = "./Results/Intermediate_results/ORA_Results_Bottomly_OriginalPhenotype.RData")
...
save(optim_ORA_results_Bottomly_phenotypepermutation,
     file = "./Results/Intermediate_results/ORA_Results_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Optimisation_functions/task1_OptimisationFunctions_cP_GSEA.R")
...
save(optim_cP_GSEA_results_Pickrell_originalphenotype,
     file = "./Results/Intermediate_results/cP_GSEA_Results_Pickrell_OriginalPhenotype.RData")
...
save(optim_cP_GSEA_results_Pickrell_phenotypepermutation,
     file = "./Results/Intermediate_results/cP_GSEA_Results_Pickrell_PhenotypePermutations.RData")
...
save(optim_cP_GSEA_results_Bottomly_originalphenotype,
     file = "./Results/Intermediate_results/cP_GSEA_Results_Bottomly_OriginalPhenotype.RData")
...
save(optim_cP_GSEA_results_Bottomly_phenotypepermutation,
     file = "./Results/Intermediate_results/cP_GSEA_Results_Bottomly_PhenotypePermutations.RData")
