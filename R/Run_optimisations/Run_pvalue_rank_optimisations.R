...
if(!dir.exists("./Intermediate_results")){dir.create(path = "./Intermediate_results")}
...
source("./R/Functions/rank_p_OptimisationFunctions_GOSeq.R")
...
save(optimP_GOSeq_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_GOSeq_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimP_GOSeq_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_GOSeq_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimP_GOSeq_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_GOSeq_Demethylation_Pickrell_OriginalPhenotype.RData")
...
save(optimP_GOSeq_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_GOSeq_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimP_GOSeq_MetabolicProcess_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_GOSeq_MetabolicProcess_Bottomly_OriginalPhenotype.RData")
...
save(optimP_GOSeq_MetabolicProcess_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimP_GOSeq_MetabolicProcess_Bottomly_PhenotypePermutations.RData")
...
save(optimP_GOSeq_CellularProcess_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_GOSeq_CellularProcess_Bottomly_OriginalPhenotype.RData")
...
save(optimP_GOSeq_CellularProcess_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimP_GOSeq_CellularProcess_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_GOSeq_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_GOSeq_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_GOSeq_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_GOSeq_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_GOSeq_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_GOSeq_Demethylation_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_GOSeq_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_GOSeq_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_GOSeq_MetabolicProcess_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_GOSeq_MetabolicProcess_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_GOSeq_MetabolicProcess_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimRank_GOSeq_MetabolicProcess_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_GOSeq_CellularProcess_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_GOSeq_CellularProcess_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_GOSeq_CellularProcess_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimRank_GOSeq_CellularProcess_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Functions/rank_p_OptimisationFunctions_PADOG.R")
...
save(optimP_PADOG_PrimaryImmunodeficiency_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Pickrell_OriginalPhenotype.RData")
...
save(optimP_PADOG_PrimaryImmunodeficiency_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Pickrell_PhenotypePermutations.RData")
...
save(optimP_PADOG_GraftvsHost_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_PADOG_GraftvsHost_Pickrell_OriginalPhenotype.RData")
...
save(optimP_PADOG_GraftvsHost_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_PADOG_GraftvsHost_Pickrell_PhenotypePermutations.RData")
...
save(optimP_PADOG_PrimaryImmunodeficiency_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Bottomly_OriginalPhenotype.RData")
...
save(optimP_PADOG_PrimaryImmunodeficiency_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimP_PADOG_PrimaryImmunodeficiency_Bottomly_PhenotypePermutations.RData")
...
save(optimP_PADOG_GraftvsHost_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_PADOG_GraftvsHost_Bottomly_OriginalPhenotype.RData")
...
save(optimP_PADOG_GraftvsHost_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimP_PADOG_GraftvsHost_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_PADOG_PrimaryImmunodeficiency_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_PADOG_PrimaryImmunodeficiency_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_PADOG_GraftvsHost_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_PADOG_GraftvsHost_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_PADOG_GraftvsHost_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_PADOG_GraftvsHost_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimRank_PADOG_PrimaryImmunodeficiency_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_PADOG_GraftvsHost_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_PADOG_GraftvsHost_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_PADOG_GraftvsHost_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimRank_PADOG_GraftvsHost_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Functions/rank_p_OptimisationFunctions_cP_ORA.R")
...
save(optimP_cP_ORA_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_ORA_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimP_cP_ORA_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_ORA_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimP_cP_ORA_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_ORA_Demethylation_Pickrell_OriginalPhenotype.RData")
...
save(optimP_cP_ORA_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_ORA_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimP_cP_ORA_tCell_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_ORA_tCell_Bottomly_OriginalPhenotype.RData")
...
save(optimP_cP_ORA_tCell_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimP_ORA_tCell_Bottomly_PhenotypePermutations.RData")
...
save(optimP_cP_ORA_Demethylation_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_ORA_Demethylation_Bottomly_OriginalPhenotype.RData")
...
save(optimP_cP_ORA_Demethylation_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimP_ORA_Demethylation_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_cP_ORA_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_ORA_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_cP_ORA_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_ORA_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_cP_ORA_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_ORA_Demethylation_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_cP_ORA_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_ORA_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_cP_ORA_tCell_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_ORA_tCell_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_cP_ORA_tCell_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimRank_ORA_tCell_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_cP_ORA_Demethylation_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_ORA_Demethylation_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_cP_ORA_Demethylation_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimRank_ORA_Demethylation_Bottomly_PhenotypePermutations.RData")
...
# load optimisation functions
source("./R/Functions/rank_p_OptimisationFunctions_cP_GSEA.R")
...
save(optimP_cP_GSEA_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_cP_GSEA_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimP_cP_GSEA_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_cP_GSEA_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimP_cP_GSEA_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimP_cP_GSEA_Demethylation_Pickrell_OriginalPhenotype.RData")
...
save(optimP_cP_GSEA_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimP_cP_GSEA_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimP_cP_GSEA_tCell_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_cP_GSEA_tCell_Bottomly_OriginalPhenotype.RData")
...
save(optimP_cP_GSEA_tCell_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimP_cP_GSEA_tCell_Bottomly_PhenotypePermutations.RData")
...
save(optimP_cP_GSEA_Demethylation_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimP_cP_GSEA_Demethylation_Bottomly_OriginalPhenotype.RData")
...
save(optimP_cP_GSEA_Demethylation_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimP_cP_GSEA_Demethylation_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_tcell_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_cP_GSEA_tCell_Pickrell_OriginalPhenotype.RData")
...
save(optimRank_tcell_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_cP_GSEA_tCell_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_Demethylation_Pickrell_originalphenotype,
     file = "./Intermediate_results/optimRank_cP_GSEA_Demethylation_OriginalPhenotype.RData")
...
save(optimRank_Demethylation_Pickrell_phenotypepermutations,
     file = "./Intermediate_results/optimRank_cP_GSEA_Demethylation_Pickrell_PhenotypePermutations.RData")
...
save(optimRank_tCell_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_cP_GSEA_tCell_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_tCell_Bottomly_phenotypepermutations,
     file = "./Intermediate_results/optimRank_cP_GSEA_tCell_Bottomly_PhenotypePermutations.RData")
...
save(optimRank_Demethylation_Bottomly_originalphenotype,
     file = "./Intermediate_results/optimRank_cP_GSEA_Demethylation_Bottomly_OriginalPhenotype.RData")
...
save(optimRank_Demethylation_Bottomly_Phenotypepermutations,
     file = "./Intermediate_results/optimRank_cP_GSEA_Demethylation_Bottomly_PhenotypePermutations.RData")
