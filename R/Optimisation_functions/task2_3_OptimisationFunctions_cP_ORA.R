...
# function arguments of pvalue_rank_ORA()
# - term: gene set (i.e., gene set ID)
# - ora_results: ORA results table
# - metric: either "p_adj" or "rank"
#           "p_adj": extract gene set's adjusted p-value from ORA results table
#           "rank": adjust gene set's rank among all other gene sets from ORA results table
...
# whether it is not differentially enriched or if it does not appear in the gene set database at all
...
# this function extracts the list of differentially expressed genes from a
# results table of differential expression analysis
# -> this is the required input for ORA
...
# function arguments:
# - DE_results: results table of differential expression analysis
# - geneset_database: gene set database (either "KEGG" or "GO"; "GO" stands for GO with
#                     subontology Biological Processes)
# - organism:
...
# function arguments:
# - geneset: gene set (i.e., its ID) whose adjusted p-value or rank is to be optimized
# - metric: either "p_adj" or "rank"
#         "p_adj": minimize the gene set's adjusted p-value in the ORA results
#         "rank": minimize the gene set's rank among all gene sets in the ORA results
...
# - geneset_database: geneset_database (either "GO" or "KEGG")
