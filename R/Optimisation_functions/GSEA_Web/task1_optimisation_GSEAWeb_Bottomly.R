...
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Raw")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Prep")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Prep/Phen_Original")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Prep/Phenotypes")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Raw/Phen_Original")
dir.create("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Raw/Phenotypes")
...
# generate path
path_dat_vst_phenorig <- paste0("./Results/Intermediate_results/GSEA_Web/Bottomly/Data_task1/Raw/Phen_Original/exprdat_vst_phen_original.txt")
