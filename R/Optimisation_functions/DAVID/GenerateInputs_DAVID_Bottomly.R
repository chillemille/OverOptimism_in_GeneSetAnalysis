...
dir.create("./Results/Intermediate_results/DAVID/Bottomly")

# create folder to contain all data
dir.create("./Results/Intermediate_results/DAVID/Bottomly/Data")

# create folder to contain the data for the true sample labels
dir.create("./Results/Intermediate_results/DAVID/Bottomly/Data/Phen_Original")

for(i in 1:10){

  path_data_permutations <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Permutation", i)
...
# for both DE methods, create vector which contains number of DIFFERENTIALLY EXPRESSED GENES for each random phenotype permutation
  ...
  path_DEGs_deseq2_phenorig <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Phen_Original/DEGs_DESeq2_phenOriginal.txt")
  ...
  # create path for storage of DESeq2 results
  path_universe_deseq2_phenorig <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Phen_Original/universe_DESeq2_phenOrig.txt")
  ...
  path_DEGs_limma_phenorig <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Phen_Original/DEGs_limma_phenOrig.txt")
  ...
  # create path for storage of limma results
  path_universe_limma_phenorig <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Phen_Original/universe_limma_phenOrig.txt")
...
for(i in 1:ncol(phen_bottomly)){
  ...
  # create path for storage of DESeq2 results
  path_DEGs_deseq2 <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Permutation", i, "/DEGs_DESeq2_permutation",i,".txt")
  ...
  # create path for storage of DESeq2 results
  path_universe_deseq2 <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Permutation", i, "/universe_DESeq2_permutation",i,".txt")
  ...
  # create path for storage of limma results
  path_DEGs_limma <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Permutation", i, "/DEGs_limma_permutation",i,".txt")
  ...
  # create path for storage of limma results
  path_universe_limma <- paste0("./Results/Intermediate_results/DAVID/Bottomly/Data/Permutation", i, "/universe_limma_permutation",i,".txt")
