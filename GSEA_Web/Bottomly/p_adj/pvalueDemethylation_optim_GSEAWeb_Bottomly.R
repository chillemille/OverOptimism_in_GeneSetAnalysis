...
# export phenotype assignments and gene expression data set pre-processed in default manner 
  ...
  path_phen <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phenotypes/Phenotype_original.txt")
  ...
  # generate path 
  path_dat_phenorig <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_default_phen_original.txt")
  ...
  # generate path 
  path_dat_vst_phenorig <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_vst_phen_original.txt")
...
#########
  ...
  ### export 
  path_filterByExpr_phenorig <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Original/exprdat_filterByExpr_phenorig.txt")
...
for(i in 1:ncol(phen_bottomly)){
  ...
  path_phen <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phenotypes/Phenotype_Permutation",i, ".txt")
  ...
  # generate path 
  path_dat <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_default_phen_permutation", i, ".txt")
  ...
  # generate path 
  path_dat_vst <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_vst_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen1 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
# perform voom-transformation on accordingly pre-filtered pickrell data set
exprdat_prefilt_phen2 <- voom_trans(Biobase::exprs(bottomly.eset)[prefilt_ind_phen2,], phenotype_labels = phen_bottomly[,2])

### export 
path_filterByExpr_phen2 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen3 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen4 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
# perform voom-transformation on accordingly pre-filtered pickrell data set
exprdat_prefilt_phen5 <- voom_trans(Biobase::exprs(bottomly.eset)[prefilt_ind_phen5,], phenotype_labels = phen_bottomly[,5])

### export 
path_filterByExpr_phen5 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen6 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
# perform voom-transformation on accordingly pre-filtered pickrell data set
exprdat_prefilt_phen7 <- voom_trans(Biobase::exprs(bottomly.eset)[prefilt_ind_phen7,], phenotype_labels = phen_bottomly[,7])

### export 
path_filterByExpr_phen7 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen8 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
# perform voom-transformation on accordingly pre-filtered pickrell data set
exprdat_prefilt_phen9 <- voom_trans(Biobase::exprs(bottomly.eset)[prefilt_ind_phen9,], phenotype_labels = phen_bottomly[,9])

### export 
path_filterByExpr_phen9 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
...
### export 
path_filterByExpr_phen10 <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEA_Web/Bottomly/p_value/Data_Demethylation/Raw/Phen_Permutation",i,"/exprdat_filterByExpr_phen_permutation", i, ".txt")
