...
# Demethylation
load("./Results/optimP_ORA_Demethylation_Bottomly_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/optimP_ORA_tCell_Bottomly_OriginalPhenotype.RData")
...
## uncomment to save
ggsave2("./Results_illustrations/FigureS3.pdf",
        width = 10,
        height = 12)
