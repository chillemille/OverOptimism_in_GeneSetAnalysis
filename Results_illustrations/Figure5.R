...
# Demethylation
load("./Results/optimRank_GOSeq_Demethylation_Pickrell_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/optimRank_GOSeq_tCell_Pickrell_OriginalPhenotype.RData")


# Load clusterProfiler's ORA results

# Demethylation
load("./Results/optimRank_ORA_Demethylation_Pickrell_OriginalPhenotype.RData")

# t Cell mediated immunity
load("./Results/optimRank_ORA_tCell_Pickrell_OriginalPhenotype.RData")
...
# Demethylation
load("./Results/optimRank_cP_GSEA_Demethylation_OriginalPhenotype.RData")

# t-Cell mediated immunity
load("./Results/optimRank_cP_GSEA_tCell_Pickrell_OriginalPhenotype.RData")


# Load PADOG results

# (i) Primary Immunodeficiency
load("./Results/optimRank_PADOG_PrimaryImmunodeficiency_Pickrell_OriginalPhenotype.RData")

# (ii) Graft vs Host
load("./Results/optimRank_PADOG_GraftvsHost_Pickrell_OriginalPhenotype.RData")
...
## uncomment to save
ggsave("./Results_illustrations/Figure5.eps",
        width = 10,
        height = 12)
