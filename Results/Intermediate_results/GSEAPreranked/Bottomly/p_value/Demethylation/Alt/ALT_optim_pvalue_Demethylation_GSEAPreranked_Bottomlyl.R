...
# load data set together with the true sample conditions and the permutations 
...
geneID_conversion_SYMBOL <- function(expression_data, dupl_removal_method){
  ...
  # expression_data <- pre_filt(Biobase::exprs(bottomly.eset), threshold = 10)
...
path_DESeq2_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Original_Phenotype/DESeq2_ranking_phenOrig.txt"
...
path_limma_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Original_Phenotype/limma_ranking_phenOrig.txt"
...
# extract moderated t-statistics from limma results (together with gene IDs)
limma_moderatedt <- cbind(rownames(limma_results), limma_results$t)
names(limma_moderatedt) <- rownames(limma_results)
# order by t-statistics in descending order 
limma_moderatedt <- sort(limma_moderatedt, decreasing=TRUE) %>% as.data.frame()
# Create path for storage of limma ranking  

path_limma_modt_phenorig <- "/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Original_Phenotype/limma_ranking_modt_phenOrig.txt"


# export 
write.table(limma_moderatedt, 
            file = path_limma_modt_phenorig, 
            quote = FALSE, 
            row.names = TRUE, 
            col.names = FALSE)   
...
for(i in 1:ncol(phen_bottomly)){
  ...
  # Create path for storage of limma ranking            
  path_limma_phenperm <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Phenotype_Permutation",i,"/limma_ranking_byp_permutation",i,".txt")
  ...
  # extract moderated t-statistics from limma results (together with gene IDs)
  limma_moderatedt_phenperm <- as.vector(limma_results_phenperm$t)
  names(limma_moderatedt_phenperm) <- rownames(limma_results_phenperm)
  # order by t-statistics in descending order 
  limma_moderatedt_phenperm <- sort(limma_moderatedt_phenperm,decreasing=TRUE) %>% as.data.frame()
  
  # Create path for storage of limma ranking            
  path_limma_modt_phenperm <- paste0("/nfsmb/koll/milena.wuensch/Dokumente/Overoptimism_NEU/NEU/OverOptimism_GSA/GSEAPreranked/Bottomly/p_value/Demethylation/Data/Raw/Phenotype_Permutation",i,"/limma_ranking_modt_permutation",i,".txt")
  
  
  # export 
  write.table(limma_moderatedt_phenperm, 
              file = path_limma_modt_phenperm, 
              quote = FALSE, 
              row.names = TRUE, 
              col.names = FALSE)   
...
# alternative 1: limma, ranking by p.value -> adj. p-value = 0.915544
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.81665254
# ->> proceed with ranking generated using limma's moderated t-statistic 
...
# alternative 1: exponent 0 -> adj. p-value = 0.9143661
# alternative 2: exponent 1.5 -> adj. p-value = 1
# alternative 3: exponent 2 -> adj. p-value = 0.9811251

### -> final results: adj. p-value = 0.81665254
# achieved with ALTERNATIVE ranking generated using limma's moderated t-statistic
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.55496174
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.5919185

# proceed with alternative ranking generated using limma and ranking by p-value 

#########
# 3. step: change exponent 
#########

# alternative 1: exponent 0 -> adj. p-value = 0.8116958
# alternative 2: exponent 1.5 -> adj. p-value = 0.80135155
# alternative 3: exponent 2 -> adj. p-value = 0.67773724


# ->> final results: adj. p-value = 0.55496174
# achieved with ALTERNATIVE ranking, generated using limma and ranking by p-value
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.93905836
# alternative 2: limma, moderated t-statistic -> adj. p.-value = 0.9623205
...
# alternative 1: exponent 0 -> adj. p-value = 0.6263847
# alternative 2: exponent 1.5 -> adj. p-value = 0.9494774
# alternative 3: exponent 2 -> adj. p-value = 0.9236777



### -> final results: adj. p-value = 0.6263847
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 1
# alternative 2: limma, moderated t-statistic -> adj. p-value = 1
...
# alternative 1: exponent 0 -> adj. p-value = 0.97039825
# alternative 2: exponent 1.5 -> adj. p-value = 0.9869152
# alternative 3: exponent 2 -> adj. p-value = 0.99492097

### final results: 0.9433123
# optimal parameter setting coincides with default setting 
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.36329165
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.32546592
...
# alternative 1: exponent 0 -> adj. p-value = 0.2323441
# alternative 2: exponent 1.5 -> adj. p-value = 0.10092047
# alternative 3: exponent 2 -> adj. p-value = 0.39456075

# final results: adj. p-value = 0.10092047
# achieved with 
# ALTERNATIVE ranking generated using limma's moderated t-statistic
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.99798036
# alternative 2: limma, ranking using moderated t-statistic -> adj. p-value = 0.9962277
...
# alternative 1: exponent 0 -> adj. p-value = 0.9785103
# alternative 2: exponent 1.5 -> adj. p-value = 0.76442146
# alternative 3: exponent 2 -> adj. p-value =0.8526683


### final results: adj. p-value = 0.76442146
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.62728566
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.71679735

# -> proceed with the rannking generated using limma and ranking by p-value

#########
# 3. step: change exponent 
#########

# alternative 1: exponent 0 -> adj. p-value = 0.559704
# alternative 2: exponent 1.5 -> adj. p-value = 0.8230824
# alternative 3: exponent 2 -> adj. p-value = 0.7994512

# final results: adj. p-value = 0.559704
# achieved with 
# ALTERNATIVE ranking using limmas ranking by p-value 
...
# -> adj. p-value = 0.9165499

#########
# 2. step: change method to generate ranking
#########

# alternative 1: limma, ranking by p-value -> adj. p-value = 0.9327711
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.7887249

# proceed with alternative ranking using limma's moderated t-statistic 

#########
# 3. step: change exponent 
#########

# alternative 1: exponent 0 -> adj. p-value = 0.6062093
# alternative 2: exponent 1.5 -> adj. p-value = 1
# alternative 3: exponent 2 -> adj. p-value = 0.9446799


# final results: adj. p-value = 0.6062093
# achieved with 
# ALTERNATIVE ranking using limma's moderated t-statistic 
# ALTERNATIVE exponent 0 
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.4224315
# alternative 2: limma, moderated t-statistic -> adj. p-value = 0.5824832

# proceed with limma, ranking by p-value 

#########
# 3. step: change exponent 
#########

# alternative 1: exponent 0 -> adj. p-value = 0.77543384
# alternative 2: exponent 1.5 -> adj. p-value = 0.63985443
# alternative 3: exponent 2 -> adj. p-value = 0.32535723


### final results: adj. p-value = 0.32535723
# achieved with 
# ALTERNATIVE ranking generated using limma and ranking by p-value
...
# alternative 1: limma, ranking by p-value -> adj. p-value = 0.4962546
# altermative 2: limma's moderated t-statistic -> adj. p-value = 0.42854923

# proceed with limma's moderated t-statistic 

#########
# 3. step: change exponent 
#########

# alternative 1: exponent 0 -> adj. p-value = 0.37623623
# alternative 2: exponent 1.5 -> adj. p-value = 0.35465804
# alternative 3: exponent 2 -> adj. p-value = 0.6129725

### ->> final results: final results: adj. p-value = 0.35465804
# achieved with
# ALTERNATIVE ranking using limma and ranking by p-value 
# ALTERNATIVE exponent 1.5 
...
# alternative1 : limma, ranking by p-value  -> adj. p-value = 0.44814402
# alternative 2: limma's moderated t-statistic -> adj. p-value =  0.432023
...
# alternative 1: exponent 0 ->  adj. p-value = 0.51142824
# alternative 2: exponent 1.5 -> adj. p-value = 0.26743433
# alternative 3: exponent 2 -> adj. p-value = 0.3438879


### -> final results: adj. p-value = 0.26743433
# achieved with 
# ALTERNATIVE exponent 1.5 
