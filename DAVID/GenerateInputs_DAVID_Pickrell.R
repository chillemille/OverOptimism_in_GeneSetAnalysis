...
dir.create("./DAVID/Pickrell")

# create folder to contain all data
dir.create("./DAVID/Pickrell/Data")

# create folder to contain the data for the true sample labels
dir.create("./DAVID/Pickrell/Data/Phen_Original")

for(i in 1:10){

  path_data_permutations <- paste0("./DAVID/Pickrell/Data/Permutation", i)
...
path_DEGs_deseq2_phenorig <- paste0("./DAVID/Pickrell/Data/Original_Phenotype/DEGs_DESeq2_phenorig.txt")
...
# create path for storage of DESeq2 results
path_universe_deseq2_phenorig <- paste0("./DAVID/Pickrell/Data/Original_Phenotype/universe_DESeq2_phenorig.txt")
...
path_DEGs_limma_phenorig <- paste0("./DAVID/Pickrell/Data/Original_Phenotype/DEGs_limma_phenorig.txt")
...
# create path for storage of limma results
path_universe_limma_phenorig <- paste0("./DAVID/Pickrell/Data/Original_Phenotype/universe_limma_phenorig.txt")
...
for(i in 1:ncol(phen_pickrell)){
  ...
  # create path for storage of DESeq2 results
  path_DEGs_deseq2 <- paste0("./DAVID/Pickrell/Data/Permutation", i, "/DEGs_DESeq2_permutation",i,".txt")
  ...
  # create path for storage of DESeq2 results
  path_universe_deseq2 <- paste0("./DAVID/Pickrell/Data/Permutation", i, "/universe_DESeq2_permutation",i,".txt")
  ...
  # create path for storage of limma results
  path_DEGs_limma <- paste0("./DAVID/Pickrell/Data/Permutation", i, "/DEGs_limma_permutation",i,".txt")
  ...
  # create path for storage of limma results
  path_universe_limma <- paste0("./DAVID/Pickrell/Data/Permutation", i, "/universe_limma_permutation",i,".txt")
